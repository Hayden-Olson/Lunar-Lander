  ...
  ***************************************/
  ...
  // display zero
    ...
    {  // setup
        ...
        aConst.display(out);
        // verify
        assertCondition(out.str() == std::string("0.0degrees"));
        assertValues(aConst.radians, 0.0, 0.001);
    }  // teardown
    ...
    {  // setup
        ...
        aConst.display(out);
        // verify
        assertCondition(out.str() == std::string("90.0degrees"));
        assertValues(aConst.radians, 1.570795, 0.001);
    }  // teardown
    ...
    {  // setup
        ...
        aConst.display(out);
        // verify
        assertCondition(out.str() == std::string("180.0degrees"));
        assertValues(aConst.radians, 3.14159, 0.001);
    }  // teardown
    ...
    {  // setup
        ...
        aConst.display(out);
        // verify
        assertCondition(out.str() == std::string("359.5degrees"));
